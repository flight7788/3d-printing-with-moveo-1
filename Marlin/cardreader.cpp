...
void CardReader::write_Str(char *buf)
{
    char *begin = buf;
...
#define _SORT_CMP_NODIR() (strcasecmp(name1, name2) > 0)
                    ...
                    const uint8_t ind1 = o1 >> 3, bit1 = o1 & 0x07, ind2 = o2 >> 3, bit2 = o2 & 0x07;
#define _SORT_CMP_DIR(fs)                                                                                                                                      \
    (((isDir[ind1] & _BV(bit1)) != 0) == ((isDir[ind2] & _BV(bit2)) != 0) ? _SORT_CMP_NODIR()                                                                  \
...
int16_t CardReader::loadJobRecoveryInfo() { return jobRecoveryFile.read(&job_recovery_info, sizeof(job_recovery_info)); }
